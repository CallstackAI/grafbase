...
/// as the positions within the list_wrapping bits. Acting like a fixed size VecDeque.
...
mod tests {
    ...
    fn test_wrapping() {
        ...
        println!("{:?}", wrapping);
        assert_eq!(wrapping.inner_is_required(), true);
        assert_eq!(wrapping.is_required(), true);
        assert_eq!(wrapping.is_list(), false);
        assert_eq!(wrapping.list_wrappings().collect::<Vec<_>>(), vec![]);

        let mut wrapping = Wrapping::nullable();
        println!("{:?}", wrapping);
        assert_eq!(wrapping.inner_is_required(), false);
        assert_eq!(wrapping.is_required(), false);
        assert_eq!(wrapping.is_list(), false);
        assert_eq!(wrapping.list_wrappings().collect::<Vec<_>>(), vec![]);
        ...
        assert_eq!(wrapping.inner_is_required(), false);
        assert_eq!(wrapping.is_required(), false);
        assert_eq!(wrapping.is_list(), true);
        assert_eq!(
